...
namespace Backend.Migrations
{
    ...
    [Migration("20260803150045_AddAsignacionEncuestas")]
    partial class AddAsignacionEncuestas
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Models.Encuesta", b =>
                {
                    ...
                    b.Property<string>("CursoAsignado")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("EstudianteAsignadoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EstudianteAsignadoId");
            ...
            modelBuilder.Entity("Backend.Models.Encuesta", b =>
                {
                    ...
                    b.HasOne("Backend.Models.Estudiante", "EstudianteAsignado")
                        .WithMany()
                        .HasForeignKey("EstudianteAsignadoId");

                    b.Navigation("Colegio");

                    b.Navigation("CreadoPorUsuario");

                    b.Navigation("EstudianteAsignado");
                });
